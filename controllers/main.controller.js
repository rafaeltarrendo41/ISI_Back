...
function validarCompanies(request, response) {
    ...
    connect.query(`UPDATE companies SET verificado = 1 WHERE idcompanies = ${idCompanie}`, (err, rows, fields) => {
        if (!err) {
            ...
            //     'verificado': true
            // })
            let bodycontent = `<h1><img src="https://github.com/rafaeltarrendo41/ISI/blob/main/Templates/uploads_sites/2/2016_01/wtransnet_logo.png?raw=true"> </h1>
            <br> <br> <br> <br> Bem vindo à Wtransnet, <br> <br>
